  ...
  render() {
    ...
    return (
      <Layout>
        ...
        >
          <div className="logo">
              {this.state.collapsed ? (<h1>JT</h1>) : (<h1>JobTracker</h1>)}
          </div>
          <Menu theme="dark" mode="inline" defaultSelectedKeys={[window.location.pathname]}>
            ...
            {user.role ==="recruiter" && <Menu.Item key="/postjob" icon={<PlusOutlined />}>
            <Link to='/postjob'>Post Job</Link>
            </Menu.Item>}

            {user.role ==="recruiter" && <Menu.Item key="/posted" icon={<CheckOutlined />}>
